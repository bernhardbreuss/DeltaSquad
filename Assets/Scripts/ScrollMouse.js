...
var ZoomRange:Vector2 = Vector2(-250,500);
...

{
...

    {
        ...
        transform.Translate(Vector3.right * Time.deltaTime * PanSpeed * (Input.mousePosition.y - Screen.height * 0.5)/(Screen.height* 0.5), Space.World);
        transform.Translate(Vector3.forward * Time.deltaTime * -PanSpeed * (Input.mousePosition.x - Screen.width *0.5)/(Screen.width * 0.5), Space.World);
    }
